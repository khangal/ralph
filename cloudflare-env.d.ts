/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 4fe4783887f65aa419a6692a8b9288af)
// Runtime types generated with workerd@1.20250902.0 2025-05-23 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		CLADE_KV: KVNamespace;
		NEXTJS_ENV: string;
		DB: D1Database;
